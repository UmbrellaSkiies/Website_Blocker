...
# Create status_label as a global variable
...
def unblock_website():
    ...
    with open(host_path, 'r+') as host_file:
        ...
        host_file.seek(0)
        blocked = False  # Flag to track if any website was unblocked
        for line in lines:
